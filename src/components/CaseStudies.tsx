            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '1.5rem' }}>
                  ...
                  >
                    <span style={{ fontSize: '0.65rem', fontWeight: 800, color: '#F87171', textTransform: 'uppercase', letterSpacing: '0.08em', display: 'block', marginBottom: '2px' }}>
                  ...
                  >
                    <span style={{ fontSize: '0.65rem', fontWeight: 800, color: '#00E599', textTransform: 'uppercase', letterSpacing: '0.08em', display: 'block', marginBottom: '2px' }}>
                ...
                <div>
                  <div style={{ fontSize: '0.65rem', fontWeight: 700, color: T.muted, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '0.65rem' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(190px, 1fr))', gap: '0.5rem' }}>
                    {activeCase.architecture.map((arch: string, ai: number) => (
                      <div key={ai} style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.78rem', color: 'rgba(255, 255, 255, 0.85)' }}>
              ...
              <div className="metrics-panel">
                <div style={{ fontSize: '0.65rem', fontWeight: 700, color: T.muted, textTransform: 'uppercase', letterSpacing: '0.1em', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <span>{t.metricsTitle || 'SYSTEM IMPACT METRICS'}</span>
                  <span style={{ color: '#00E599', fontSize: '0.6rem', fontFamily: 'var(--font-mono, monospace)' }}>[ VERIFIED ]</span>
                </div>
