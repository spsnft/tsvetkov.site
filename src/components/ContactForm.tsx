...
export const ContactForm = () => {
  ...
  return (
    <div className="contact-grid">
      {/* ЛЕВАЯ КОЛОНКА (Кнопки быстрых связей) */}
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div className="element-wrapper">
          ...
          <p style={{ fontSize: '0.95rem', lineHeight: 1.6, margin: '0 0 2.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
            ...
            {/* Secondary Link: LinkedIn */}
            <a
              href="https://linkedin.com/in/tsvetkov-marketing/"
              target="_blank" 
              rel="noopener noreferrer"
              className="btn-secondary"
              style={{ width: '100%', justifyContent: 'space-between', background: 'rgba(255,255,255,0.02)', borderColor: 'rgba(255,255,255,0.08)' }}
            >
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: '11px', 
                  fontWeight: 700, 
                  color: copied ? T.accent : 'rgba(255,255,255,0.5)',
                  cursor: 'pointer', 
                  display: 'inline-flex', 
                  alignItems: 'center',
                  backgroundColor: copied ? 'rgba(0,255,179,0.08)' : 'rgba(255,255,255,0.04)',
                  border: `1px solid ${copied ? `${T.accent}40` : 'rgba(255,255,255,0.1)'}`,
                  transition: 'all 0.2s', 
                  fontFamily: 'inherit'
                }}
              >
      ...
      <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
        <div className="element-wrapper" style={{ width: '100%' }}>
          <div className="card-glass-glow" style={{ padding: '2.5rem 2rem' }}>
