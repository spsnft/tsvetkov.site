...
export const contentData = {
  ...
  ru: {
    ...
    aboutClosingLine: "От первого сообщения до запуска вы имеете дело со мной — а не с очередью поддержки.",
    ...
    footerSub1: "Калькулятор считает по средним показателям. Разбор выручки — по вашим реальным объявлениям.",
  ...
  th: {
    ...
    aboutClosingLine: "ตั้งแต่ข้อความแรกจนถึงวันเปิดใช้งาน คุณติดต่อกับผมโดยตรง ไม่ใช่คิวซัพพอร์ต",
