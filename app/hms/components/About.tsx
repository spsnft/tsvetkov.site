  ...
  return (
    <section id="about" className="about-section">
      <style jsx>{`
        ...
        .about-text {
          /* Было 48px — тот же «section-header → content» токен, что
             чинили в Pricing/FooterCTA (backlog-пакет 3, п. A7), здесь
             применён к паре заголовок/подзаголовок (имя → роль),
             а не к переходу секции. 24px — пропорционально межабзацному
             интервалу (16px) и ближе к Hero H1→subtitle (18px), не
             читается как разрыв между блоками (см. ТЗ пакет 5, п. 3) */
          margin: 24px 0 0 0;
          display: flex;
          flex-direction: column;
          gap: 1rem;
