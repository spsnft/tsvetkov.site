...
/**
 * Единственная точка контакта лендинга: одна кнопка на CTA-точку, ведёт в
 * WhatsApp с преднабранным текстом на языке страницы.
 *
 * Это обычная ссылка без клиентского состояния — она приходит в серверной
 * разметке с рабочим href, поэтому первый экран работает до гидрации.
 */
...
export default function WhatsAppCta({
  ...
  return (
    <a
      ...
      rel="noopener"
      className={className}
      // Иконка слева от текста, отступ 10px
